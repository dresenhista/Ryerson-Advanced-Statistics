...
```{r, echo=FALSE, fig.keep='first', fig.cap="Histogram of Quality of Wine", fig.height=3, fig.width=5}
...
```{r, echo=FALSE, fig.cap="Box plot of Level of Sulfur Dioxide by rating", fig.height=4, fig.width=5}
...
```{r, echo=FALSE, fig.cap="Level of Volatile Acidity", fig.height=4, fig.width=5}
...
\newpage
```{r, echo=FALSE, fig.cap="Total Level of alcohol"}
...
```{r, echo=FALSE, fig.width=3.5, fig.height=3.5, fig.cap = "Proportion of Variance Explained by Principal Component"}
...
```{r, warning=FALSE, echo=FALSE, fig.cap="First and third Component plots - Some Clusters are more highlited than others."}
library(lattice)
