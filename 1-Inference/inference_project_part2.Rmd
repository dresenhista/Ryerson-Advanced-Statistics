...
dose_0.5 <-create_vector(filter_data("0.5",))
dose_1<-create_vector(filter_data("1",))
dose_2<-create_vector(filter_data("2",))

stats_table<-rbind(all, orange.juice, ascorbic.acid, dose_0.5, dose_1, dose_2)
```
