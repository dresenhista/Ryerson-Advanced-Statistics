...
oj_dose1_0.5<-create_vector(filter_data("0.5","VC"))
oj_dose1_1<-create_vector(filter_data("1","VC"))
oj_dose1_2<-create_vector(filter_data("2","VC"))

stats_table<-rbind(all, orange.juice, ascorbic.acid, dose1_0.5, dose1_1, dose1_2, vc_dose1_0.5, vc_dose1_1, vc_dose1_2, oj_dose1_0.5, oj_dose1_1, oj_dose1_2)
...
library("pander")
pander(stats_table)
#knitr::kable(stats_table, caption = "Summary Table")
```
